				...
				<table class="table table-striped"
					...
					<tbody>
						<tr>
							...
							<td colspan="2"><%=boardDetail.getTitle() %></td>
						</tr>
						<tr>
							<td>작성일</td>	
							<td colspan="2"><%=boardDetail.getCreatedDate() %></td>
						</tr>
						<tr>
							<td>내용</td>	
							<td colspan="2" style="min-height: 200px; text-align: left;"><%=boardDetail.getContents() %></td>
						</tr>
